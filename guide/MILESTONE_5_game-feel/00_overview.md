...
> Part 2 — The character · milestone 5 of 12 · prev: [Gravity, jumping & the ground check](../MILESTONE_4_gravity-and-jumping/00_overview.md) · next: [The level as a Tilemap](../MILESTONE_6_tilemap-level/00_overview.md) · start: [Give movement weight](01_acceleration.md)
