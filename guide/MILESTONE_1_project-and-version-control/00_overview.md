...
and lives in a Git repository that is clean — `Library/` ignored, `.meta` files tracked, Git LFS already
configured for the binaries you have not imported yet. Nothing moves on screen: this is the ground everything
else is built on.
