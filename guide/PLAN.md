...
| Carrying a rider on a moving platform | M7 | *(none — the engine has no rider solution for Dynamic bodies)* | — | Why a rider slides off, and carrying it by moving it with the platform (movement inheritance) rather than re-parenting | **build** | |
